...
class Book : Publication {
    ...
    override func printDetails() {
        print("\(title) is a a book written by \(author) and published in the year \(yearPublished).")
    }
}
...
class Magazine : Publication {
    ...
    override func printDetails() {
        print("\(title) is a a magazine published \(frequency).")
    }
}
...
let myMag = Magazine(title: "National Geographic", author: "Various", yearPublished: 1888)
...
let myPickup = Pickup(make: "Toyota", model: "Hilux", modelYear: 2023, color: "Black", maxSpeed: 180, value: 24_000, extendedCab: true, is4WD: true, isHeavyDuty: false)


// Print out a message whether the truck has 4WD.

if myPickup.is4WD {
    print("My \(myPickup.make) \(myPickup.model) is 4WD")
} else {
    print("My \(myPickup.make) \(myPickup.model) is not 4WD")
}
...
// Answer: Set default values for the variables or create a empty initializer
