...
var variable1: [Int?] = [7]
var variable2: [Int?]? = [7]
// Answer: In variable 1 the values of the array could be nil or the array could be empty. In variable 2 the values could be nil and the array also could be nil and not exist
...
if let schrodingersCat = schrodingersCat {
    print("The cat is alive! and it's color is \(schrodingersCat)")
} else {
