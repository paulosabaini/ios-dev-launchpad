...
func getPetOpinion(about pet: Pets) {
    switch pet {
    case .Cat:
        print("Cats are my favourite kid of pet")
    case .Dog:
        print("I would love to have a dog")
    case .Fish:
        print("I prefer to let fishs be free")
    case .Bird:
        print("I prefer to let birds be free")
    case .Lizard:
        print("It's better to not have reptiles inside my house")
    case .Snake:
        print("I hate snakes")
    }
}
...
switch pet {
case .Cat, .Dog:
    print("This is a good pet for a kid")
default:
    print("This is not a good pet for a kid")
}
