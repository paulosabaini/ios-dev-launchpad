...
// because famousNumbers is a dictionary and dictionaries are not ordered, they are based on key value pairs
...
print(sumValues(of: arrayOfNumbers))
...
func removeNegativeNumbers(from numbers: [Int]) -> [Int] {
...
var positiveNumbers = removeNegativeNumbers(from: allNumbers)
...
// Answer: In the repeat while the number was incremented before the verification so the result was 101
